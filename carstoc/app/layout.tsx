                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-300 hover:text-white">Как заказать</a></li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-300 hover:text-white">Москва</a></li>
                                <li><a href="#" className="text-gray-300 hover:text-white">Санкт-Петербург</a></li>
                                <li><a href="#" className="text-gray-300 hover:text-white">Все города</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-4">Контакты</h3>
                            <p className="text-gray-300 mb-2">8 (800) 555-35-35</p>
                            <p className="text-gray-300 mb-4">info@carstoc.ru</p>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
                        <p>© 2025 Carstoc. Все права защищены.</p>
                    </div>
                </div>
            </footer>
        </div>
